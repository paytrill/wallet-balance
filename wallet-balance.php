<?php
  ...
  curl_setopt_array($curl, array(
	CURLOPT_URL => "https://paytrill.com/api/walletbalance_api.php?paytril_coin_AUTH=$paytril_coin_AUTH&paytril_user_holder=$paytril_user_holder&coin_name=$coin_name",
